...
urlpatterns = [
    ...
    path('collection/<subuuid:collection_id>/<slug:slug>', views.collection, name='collection'),
    path('collection/<uuid:collection_id>', views.collection_redirect, name='collection_uuid'),
